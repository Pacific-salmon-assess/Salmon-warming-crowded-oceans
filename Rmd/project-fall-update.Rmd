...
Covariate effects $\gamma_{k,i,t,q}$ are modelled as independent among stocks, not pooled by ocean ecosystem. The model requires that one primary covariate (SST) defines regime states, and the other (Competitors) has discrete $\gamma$ distributions corresponding with each state.
...
* A strengthening of the already negative relationship of West Coast stocks with competitor abundance, and
